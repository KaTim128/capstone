            ...
            <div class="col-lg-4 col-md-5">
                <form action="" method="post">
                    <div class="form-outline mb-4">
                        ...
                        <input type="text" id="username" name="username" class="form-control custom-input" placeholder="Enter your username" required="required">
                    </div>
                    <div class="form-outline mb-4">
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="text" id="conf_password" name="conf_password" class="form-control custom-input" placeholder="Confirm password" required="required">
                    </div>
                    <div>
                        <input type="submit" class="bg-info py-2 px-3 border-0 mb-3" 
                        name="admin_registraion" value="Register">
