      ...
      <div class=" p1 container-fluid">
        ...
        <div class=" p1 collapse navbar-collapse" id="navbarSupportedContent">
          <ul class=" p1 navbar-nav mr-auto">
            ...
            <li class=" p1 nav-item">
              <a class=" p1 nav-link nav-zoom text-light" href="cart.php">Cart<sup><i class="fa fa-shopping-cart" style="overflow:hidden" aria-hidden="true"></i><?php cartItem(); ?></sup></a>
            </li>
            <li class=" p1 nav-item">
